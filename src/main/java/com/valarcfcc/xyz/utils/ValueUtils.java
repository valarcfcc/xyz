...
public class ValueUtils {
    ...
    public static void getValue(Object obj) throws Exception {
        ...
        for (Field field : fields) {
            boolean fieldHasAnn = field.isAnnotationPresent(ValueXyz.class);
            if (fieldHasAnn) {
                ValueXyz valueAnnotation = field.getAnnotation(ValueXyz.class);
                // 获取注解的值
                String value = valueAnnotation.value();
                // 通过注解设置的值获取properties的值
                String propertiedValue = Objects.requireNonNull(PropertiesUtils.getCommonYml(value));
                // 获取属性的名字
                ...
                if (type.equals("class java.util.Date")) {
                    ...
                    m.invoke(obj, DateUtils.convert(propertiedValue));
                }
            }
        }
    }
